 ...
 * 
 */
@WebServiceClient(name = "EnrollmentServiceImplService", targetNamespace = "http://beans.core.enrollment.kalum.edu/", wsdlLocation = "http://macbook-pro-de-edwin.local:8080/EnrollmentServiceImplService/EnrollmentServiceImpl?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://macbook-pro-de-edwin.local:8080/EnrollmentServiceImplService/EnrollmentServiceImpl?wsdl");
